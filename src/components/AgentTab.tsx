    ...
    <div className="space-y-4">
      ...
      <section className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <NumberInput label="Estensione VWAP (0=off)" help={'Scarta il segnale quando il prezzo d\'ingresso è già troppo lontano dal VWAP delle 24 ore nel verso del trade, misurato in ATR. Serve a non entrare sull\'allungo: è la famiglia dei trade che vanno subito in perdita. A 3.5 si entra solo se il prezzo dista meno di 3.5 ATR dalla sua media recente. Zero disattiva il filtro.'} value={settings.perp_vwap_atr_extension_limit} step={0.1} onChange={(perp_vwap_atr_extension_limit) => patch({ perp_vwap_atr_extension_limit })} />
