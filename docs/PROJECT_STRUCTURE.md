...
|   |   |-- TradeCandleChartLW.tsx - grafico della posizione con lightweight-charts: zoom e scorrimento nel tempo, trascinamento della scala dei prezzi (che passa in manuale al tocco sull'asse, con le sigle riagganciate per fotogramma finche' il dito e' sul grafico), prezzi dei livelli nella scala di destra, sigle minute sopra le linee con scostamento fisso e affiancamento laterale quando due livelli sono vicini, distanza del trailing in percentuale, candele attenuate prima dell'ingresso e dopo l'uscita (la candela di riferimento dello stop resta accesa in viola), frecce di ingresso/uscita orientate secondo la direzione, orari in ora locale.
