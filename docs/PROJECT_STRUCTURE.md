...
|   |   |-- execution/venue_router.py - router minimo: `resolve_entry_venue` all'apertura, `resolve_position_venue` legge la venue dalla posizione e non la riseleziona mai. Nessun fallback nascosto: `venue_unavailable`.
